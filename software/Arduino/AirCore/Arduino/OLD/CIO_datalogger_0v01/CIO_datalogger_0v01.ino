...
//  delay(800);
  ...
  outADC |= byteMSB; outADC <<= 8;
  outADC |= byteMID; outADC <<= 8;
  outADC |= byteLSB;
    ...
    if (!mode)
    {
      ...
      else
      {
        ...
        for (int i=0; i <= 15; i++)
        {
          ...
          Serial.print("  prsP : ");
          Serial.print(prsP);
          Serial.print("  prsStat0 : ");
          Serial.print(prsStat0);
          Serial.print("  prsStat1 : ");
          Serial.println(prsStat1);
          getPressure(prsP, prsT, prsStat0, prsStat1);
          dtostrf(prsP, 1, 2, prsPChar);
          Serial.print("prsPChar : ");
          Serial.println(prsPChar);
          dtostrf(prsT, 1, 2, prsTChar);
          Serial.print("prsTChar : ");
          Serial.println(prsTChar);
