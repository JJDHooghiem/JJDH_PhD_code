...
const char airCore = 'B'; // Type airCore is used.
...
String findNewFileName()
{
  ...
  {
    sprintf(sz, "Data%02d%02d%02d%02d%02d%02d%02d%02d", month, day, year, hour, minute, second, airCore, i);
...
void loop(void) 
{
  float pt100t;
  char  pt100tChar[10];
  String dataString, serialString, fileName;
  unsigned long dur;
