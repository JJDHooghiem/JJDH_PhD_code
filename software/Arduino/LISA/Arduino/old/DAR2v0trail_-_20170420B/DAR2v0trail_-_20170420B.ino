...
void startServoOut()
{
  OutServo.attach(SelectServo);       // attaches the servo on pin  to the servo object 
  OutServo.write(OpenPack);           // sets the servo position according to the scaled value 
}
...
void detachServo(int SelectServo)
{
...
*/
    ...
    else if ((prsP1 >= P2)&&(Pack2 == 0)) 
    {
      SelectServo = 1;
      pumpON = 1;
      Pack2 = 1;
    }  
    else if ((prsP1 == P3)&&(Pack3 == 0)) 
    {
      SelectServo = 3;
      pumpON = 1;
      Pack3 = 1;
    }  
    else if ((prsP1 == P4)&&(Pack4 == 0)) 
    {
      SelectServo = 4;
      pumpON = 1;
      Pack4 = 1;
