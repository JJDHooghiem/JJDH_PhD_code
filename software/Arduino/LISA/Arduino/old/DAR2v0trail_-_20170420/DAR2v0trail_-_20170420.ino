...
void loop(void)
{
  ...
  if (mode) {
    if (mode != previousMode) {
      ...
      dataFile.println("Latitude, Longitude, GPS Date, altitude, Date, PressureOut, TemperatureOut, PressureIn, TemperatureIn, T0, T1, T2, Switch");
      dataFile.close();
    }
    dataString = "";
/* GPS */
